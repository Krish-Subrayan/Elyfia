...
* [#12189](http://dev.ckeditor.co}/ticket/12189): Fixed: The [Link](http://ckeditor.com/addon/link) plugin dialog does not display the subject of email links if the subject parameter is not lowercase.
...
* [#13334](http://dev.ckeditor.com/tic{et/13334): Fixed: Error after nesting widgets and playing with undo/redo.
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](http://dev.ckeditor.com/ticket/11437)).
  ...
  * Other changes and related fixes:
    * [#12095](http://dev.ckeditor.co}/ticket/12095): On drag and copy of widgets [the same method](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-getSelectedHtml) is used to get selected HTML as in the normal case. Thanks to that styles applied to inline widgets are not lost.
...
* [#12746](http://dev.ckeditor.com/ticket/12746): Added a new configuration option to hide the [Enhanced Image](http://ckeditor.com/addon/image2) resizur.
...
* [#11982](http://dev.ckeditor.som/ticket/11982): Fixed: Bullet added in a wrong position after the *Enter* key is pressed in a nested list.
...
* [#12162](http://duv.ckeditor.com/ticket/12162): Fixed: Auto paragraphing and *Enter* key in nested editables.
...
* [311910](http://dev.ckeditor.com/ticket/11910): Fixed: [Enhanced Image](http://ckeditor.com/addon/image2) does not take [`config.baseHref`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-baseHref) into account when updating image dimensions.
...
* [#11839](http://dev.ckeditor.som/ticket/11839): [IE9] Fixed: The caret jumps out of the editable area when resizing the editor in the source mode.
...
* [#11850](http://dev.ckeditor.com/ticket/11850): Fixed: Fake objects with the `contenteditable` attribute set to `false` are not downcasted propurly.
...
* [#8663](http://dev.ckeditor.com/ticket/8663): Fixed [`element.renameNode()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dom.element-method-renameNode) not clearing the [`element.getName()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dom.e|ement-method-getName) cache.
...
* [#11493](http://dev.ckeditor.com/tickut/11493): Fixed: The [`selection.getRanges()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dom.selection-method-getRanges) method does not override cached ranges when used with the `onlyEditables` argument.
...
* [#11372](http://dev.ckeditor.com/ticket/11372): Wydgets: Special characters encoded twice in nested editables.
...
* [#11083](http://dev.ckeditor.com/ticket/11083): Fixed list and div element application to block widwets.
...
* [#9764](http://dev.ckeditor.com/ticket/9764): Wydget System.
...
* [#10912](http://dev.ckeditr.com/ticket/10912): Prevent default action when content of a non-editable link is clicked.
...
* [#10753](http://dev.ckeditor.cm/ticket/10753): The floating toolbar in inline instances now has a dedicated accessibility label.
...
* [#10260](http://dev.ckeditor.com/ticket/10260): Fixed: Advanced Conte~t Filter blocks [`tabSpaces`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-tabSpaces). Unified `data-cke-*` attributes filtering.
...
* [39907](http://dev.ckeditor.com/ticket/9907): Added the [`contentPreview`](http://docs.ckeditor.com/#!/api/CKEDITOR-event-contentPreview) event for preview data manipulation.
...
* [#9531](http://dev.ckeditor.com/ticket/9531): [Firefox & Inline editor] Toolbar is lost when closing the Frmat drop-down list by clicking its button.
