...
extract($_REQUEST);
if ($gethealthid != '') {
$sql = "select * from sleeping_info where gethealthid = '".$gethealthid."' order by timestamp desc LIMIT 0,30";
$display_value = true;
}
else {
  $sql = "select * from sleeping_info order by timestamp desc LIMIT 0,300";
  $display_value = false;
}

$result = mysqli_query($conn,$sql) or die("SQL sleeping Selection error".mysqli_error($conn));
$activity_data=array();
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">List Sleeping Information</li>
      </ol>
    </section>
